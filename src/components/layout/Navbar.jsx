...
//                 'hidden md:inline-block', // Hide on <768px, show on >=768px
//                 'block min-[768px]:inline-block' // Fallback
//               )}
//             >
//               Etrack
//             </span>
...
//             <div className="flex flex-col items-center space-y-3 mb-5">
//               <div
//                 className="h-24 w-24 rounded-full bg-primary-500 flex items-center justify-center text-white text-4xl shadow-xl ring-4 ring-white/40"
//               >
//                 {user.name?.charAt(0) || 'S'}
//               </div>
//               <h2 className="text-xl font-bold">{user.name || 'Sandhya Korimi'}</h2>
